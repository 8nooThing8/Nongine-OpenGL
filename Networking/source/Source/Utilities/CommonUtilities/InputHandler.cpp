...
bool InputHandler::GetMouseButtonDown(const int aMouseButtonIndex)
{
	...
	{
	case 0:
		returnvalue = myPrevState[keycode::MOUSELBUTTON] == !myCurrState[keycode::MOUSELBUTTON];

		myPrevState[keycode::MOUSELBUTTON] = myCurrState[keycode::MOUSELBUTTON];

		return returnvalue;
	case 1:
		returnvalue = myPrevState[keycode::MOUSERBUTTON] == !myCurrState[keycode::MOUSERBUTTON];

		myPrevState[keycode::MOUSERBUTTON] = myCurrState[keycode::MOUSERBUTTON];

		return returnvalue;
	case 2:
		returnvalue = myPrevState[keycode::MBUTTON] == !myCurrState[keycode::MBUTTON];
