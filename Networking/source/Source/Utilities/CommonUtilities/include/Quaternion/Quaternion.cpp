...
#include <CU/Vector/Vector4.hpp>
#include <CU/Vector/Vector3.hpp>

#include <CU/Matrices/Matrix4x4.hpp>
...
namespace CommonUtilities
{
	...
	Vector4<float> CommonUtilities::Quaternion::ToVector4()
	{
	...
	Matrix4x4<float> CommonUtilities::Quaternion::ToMatrix() const
	{
		return Matrix4x4f::CreateRotationQuat(*this);
	}
