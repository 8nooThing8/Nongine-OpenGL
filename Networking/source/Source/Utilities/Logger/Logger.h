...
private:
	...
	struct LogStream
	{
	    ...
	    LogStream& operator<<(const MyStreamManipulator manip)
	    {
	        return manip(*this);
	    }
...
public:
	...
	static void Log(const LogCategoryBase& aCategory, const LogVerbosity::Type aVerbosity, const char* aMessage, Args... args)
	{
