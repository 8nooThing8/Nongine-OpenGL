...
public:
	...
	void Execute();
	void ExecuteWithoutDestroying();
	void Reset();

	inline bool IsFinished() const { return !isExecuting && isfinished; }
	inline bool IsExecuting() const { return isExecuting; }
	inline bool HasCommands() const { return myNumCommands != 0; }
