...
public:
	...
	void ClearSceneBuffer(float val = 1.f, int flags = 3, bool depthOnly = false) const;
	...
	void SetRenderTargetView(Microsoft::WRL::ComPtr<ID3D11RenderTargetView> aRTV, ID3D11DepthStencilView* aDSV = nullptr);
	...
	void SetDefferedBufferRT(ID3D11RenderTargetView* aRTV);
