...
Logger::LogCategoryBase::LogCategoryBase(const std::string& aName, const LogVerbosity::Type aVerbosity): Name(aName), Verbosity(aVerbosity)
{  }
...
std::string Logger::Timestamp(const bool aIncludeDate /*= false*/) const
{
...
void Logger::LogIntl(const LogCategoryBase& aCategory, const LogVerbosity::Type aVerbosity, const char* aMessage)
{
...
void Logger::Log(const LogCategoryBase& aCategory, const LogVerbosity::Type aVerbosity, const char* aMessage)
{
